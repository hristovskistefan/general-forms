Public Class ARRateBreakdownLetter
    ...
    Public Sub SendIt(ByVal o As Object, ByVal e As EventArgs) Handles btnItemLetter.Click
    ...
    Protected Sub cvAccount_ServerValidate(ByVal source As Object, ByVal args As System.Web.UI.WebControls.ServerValidateEventArgs) Handles cvAccount.ServerValidate
        ...
        Else
            ...
            Dim issueType As String = "Breakdown Letter"

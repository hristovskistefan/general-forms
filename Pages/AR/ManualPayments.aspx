...
<body>
    ...
    <div class="Container-Heading clearfix">
        <div id="Container-Title">
            Account Research - Manual Payments</div>
    ...
    <div id="Container-Content" style="font-size: .9em;">
                ...
                <tr>
                    <td align="center" colspan="4">
                        <div class="infobox bolder">
                            ...
                            when advised by RM or a Supervisor.</div>
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
        ...
        <asp:Panel ID="pnlmanual" runat="server">
            <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlCCard" runat="server">
                                ...
                                <asp:ListItem Value="Discovery"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtCCardNum" runat="server" MaxLength="16" />
                            <asp:RequiredFieldValidator runat="server" ID="Requiredfieldvalidator36" ControlToValidate="txtCCardNum"
                                ErrorMessage="Credit Card Number is required." Text="X" Font-Bold="true" Font-Size="Medium"
                                Display="Dynamic" />
                            <asp:CustomValidator runat="server" Text="X" EnableClientScript="false" Font-Bold="true"
                ...
                <tr>
                    <td>
                        <asp:Button ID="btnmanpay" OnClick="SendIt" runat="server" Width="150" Text="Submit">
                        </asp:Button>
                    </td>
                </tr>
            </table>

...
<body>
    ...
    <div class="Container-Heading clearfix">
        <div id="Container-Title">
            Account Research - Replacement Statement</div>
    ...
    <div id="Container-Content" style="font-size: .9em;">
        ...
        <asp:Panel ID="pnlrepl" runat="server">
            <table class="input" cellspacing="0" cellpadding="0" width="100%">
                    ...
                    <td>
                        ...
                        <asp:Panel runat="server" ID="pnlEmail" Visible="False">
                            ...
                            <div class="infobox">
                                ...
                                statements cannot be emailed to the customer.</div>
                        </asp:Panel>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <asp:Button ID="btnreplsend" OnClick="SendIt" runat="server" Width="150" Text="Submit">
                        </asp:Button>
                    </td>
                </tr>
            </table>

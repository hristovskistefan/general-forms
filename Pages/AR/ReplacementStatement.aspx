            ...
            <table class="input" cellspacing="0" cellpadding="0" width="100%">
                ...
                <tr>
                    <td>
                        ...
                        <asp:Panel runat="server" ID="pnlFax" Visible="False">
                            Fax Number:&nbsp;<asp:TextBox runat="server" ID="txtFaxNum"></asp:TextBox>
                        ...
                        <asp:Panel runat="server" ID="pnlEmail" Visible="False">
                            <span class="bolder">Email Address:</span>&nbsp;<asp:TextBox runat="server" ID="txtEmailAddy"></asp:TextBox>
                ...
                <tr>
                    <td>
                        ...
                        <asp:TextBox ID="txtreplcomm" runat="server" Columns="50" Rows="5" TextMode="MultiLine"

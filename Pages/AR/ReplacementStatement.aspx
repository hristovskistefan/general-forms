<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReplacementStatement.aspx.vb"
    MaintainScrollPositionOnPostback="true" Inherits="GeneralForms.ARReplacementStatement" %>
    ...
    <form id="Form1" runat="server">
        ...
        <div class="Container-Heading clearfix">
            <div id="Container-Title">
                Account Research - Replacement Statement
            </div>
        ...
        <div id="Container-Content" style="font-size: .9em;">
            ...
            <asp:Panel ID="pnlrepl" runat="server">
                <table class="input" cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                        <td valign="top" class="bolder">Timeframe:&nbsp;
                        <asp:DropDownList ID="dropmonth" runat="server" Width="160">
                            <asp:ListItem Selected="True" Value="Select One" />
                        </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="rfvTimeframe" runat="server" Text="X" Font-Bold="true"
                                Font-Size="Medium" Display="Dynamic" ControlToValidate="dropmonth" InitialValue="Select One"
                                ErrorMessage="A Timeframe must be selected." />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <br />
                            <span class="bolder">Delivery Options:</span><br />
                            <asp:RadioButtonList runat="server" ID="rblDelivery" AutoPostBack="true">
                                <asp:ListItem Value="Paper Copy" Selected="True">Paper copy</asp:ListItem>
                                <asp:ListItem Value="Email">Email (Customer must have PDF Reader to view)</asp:ListItem>
                                <asp:ListItem Value="CD">CD (PDF Reader included)</asp:ListItem>
                            </asp:RadioButtonList>
                            <asp:Panel runat="server" ID="pnlFax" Visible="False">
                                Fax Number:&nbsp;<asp:TextBox autocomplete="off" runat="server" ID="txtFaxNum"></asp:TextBox>
                                <asp:RequiredFieldValidator runat="server" ID="rfvtxtFaxNum" ControlToValidate="txtFaxNum"
                                    ErrorMessage="Fax Number is required." Text="X" Font-Bold="true" Font-Size="Medium"
                                    Display="Dynamic" />
                            </asp:Panel>
                            <asp:Panel runat="server" ID="pnlEmail" Visible="False">
                                <span class="bolder">Email Address:</span>&nbsp;<asp:TextBox autocomplete="off" runat="server" ID="txtEmailAddy"></asp:TextBox>
                                <asp:RequiredFieldValidator runat="server" ID="rfvtxtEmailAddy" ControlToValidate="txtEmailAddy"
                                    ErrorMessage="Email Address is required." Text="X" Font-Bold="true" Font-Size="Medium"
                                    Display="Dynamic" />
                                <asp:RegularExpressionValidator runat="server" ID="revEmail" ControlToValidate="txtEmailAddy"
                                    ErrorMessage="Email Address must be @wowway.com, @wideopenwest.com, or @wowway.biz." Text="X"
                                    Font-Bold="true" Font-Size="Medium" Display="Dynamic" ValidationExpression=".+(@wowway.com|@wideopenwest.com|@wowway.biz)$" /><br />
                                <div class="infobox">
                                    The customer must have had their wowway email address longer than 30 days otherwise
                                statements cannot be emailed to the customer.
                                </div>
                            </asp:Panel>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <asp:TextBox autocomplete="off" ID="txtreplcomm" runat="server" Columns="50" Rows="5" TextMode="MultiLine"
                                MaxLength="500"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Button ID="btnreplsend" OnClick="SendIt" runat="server" Width="150" Text="Submit"></asp:Button>
                        </td>
                    </tr>
                </table>
            </asp:Panel>

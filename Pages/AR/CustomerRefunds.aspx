...
<body>
    ...
    <div class="Container-Heading clearfix">
        <div id="Container-Title">
            Account Research - Customer Refunds</div>
            ...
            <table class="input" cellspacing="0" cellpadding="0" width="100%">
                ...
                <tr>
                    <td>
                        ...
                        <asp:TextBox ID="txtrefreason" runat="server" Columns="50" Rows="5" TextMode="MultiLine"
                ...
                <tr>
                    <td>
                        Comments:<br />
                        <asp:TextBox ID="txtrefcomm" runat="server" Columns="50" Rows="5" TextMode="MultiLine"
                            MaxLength="249"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Button ID="btnrefsend" OnClick="SendIt" runat="server" Width="150" Text="Submit">
                        </asp:Button>
                    </td>
                </tr>
            </table>

<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CreditReferenceLetter.aspx.vb" MaintainScrollPositionOnPostback="true"
    Inherits="GeneralForms.ARCreditReferenceLetter" %>
...
<body>
    ...
    <div class="Container-Heading clearfix">
        <div id="Container-Title">
            Account Research - Credit Reference Letter</div>
    ...
    <div id="Container-Content" style="font-size: .9em;">
                ...
                <tr>
                    <td align="center" colspan="4">
                        <div class="infobox bolder">
                            Use this form when a customer is requesting a credit reference letter. A credit
                            reference letter is a letter to be used for a mortgage application or similar credit
                            application.<br />
                            <center>
                                <font color="red">******** THE ACCOUNT RESEARCH DEPT <u>WILL NOT</u> FAX LETTERS TO
                                    CUSTOMERS ******** </font>
                            </center>
                            <br />
        ...
        <asp:Panel ID="pnlcredref" runat="server" Visible="false">
            <table class="input" cellspacing="0" cellpadding="0" width="100%">
                <tr>
                    <td>
                        <div class="sectionTitle">
                ...
                <tr>
                    <td>
                        <asp:Button ID="btncredref" OnClick="SendIt" runat="server" Width="150" Text="Submit">
                        </asp:Button>
                    </td>
                </tr>
            </table>

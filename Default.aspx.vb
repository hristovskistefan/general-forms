...
Partial Public Class _Default
    ...
    Private Sub Navigate(ByVal key As String)
        If Request.ServerVariables("SERVER_NAME").Contains("dev") Then
            'Display DEV version of links
            Select Case key
                Case "Account Research"
                    Me.RadPane2.ContentUrl = "http://cccwebdev/LegacyApps/Forms/bill_inquiry.aspx"
                Case "CreditReferenceLetter"
                    Me.RadPane2.ContentUrl = "http://interwebdev/GeneralForms/Pages/AR/CreditReferenceLetter.aspx"
                Case "CustomerRefunds"
                    Me.RadPane2.ContentUrl = "http://interwebdev/GeneralForms/Pages/AR/CustomerRefunds.aspx"
                Case "DueDateChange"
                    Me.RadPane2.ContentUrl = "http://interwebdev/GeneralForms/Pages/AR/DueDateChange.aspx"
                Case "IncorrectBill"
                    Me.RadPane2.ContentUrl = "http://interwebdev/GeneralForms/Pages/AR/IncorrectBill.aspx"
                Case "ManualPayments"
                    Me.RadPane2.ContentUrl = "http://interwebdev/GeneralForms/Pages/AR/ManualPayments.aspx"
                Case "MisappliedOrUnpostedPayment"
                    Me.RadPane2.ContentUrl = "http://interwebdev/GeneralForms/Pages/AR/MisappliedOrUnpostedPayment.aspx"
                Case "NameChange"
                    Me.RadPane2.ContentUrl = "http://interwebdev/GeneralForms/Pages/AR/NameChange.aspx"
                Case "RateBreakdownLetter"
                    Me.RadPane2.ContentUrl = "http://interwebdev/GeneralForms/Pages/AR/RateBreakdownLetter.aspx"
                Case "ReplacementStatement"
                    Me.RadPane2.ContentUrl = "http://interwebdev/GeneralForms/Pages/AR/ReplacementStatement.aspx"
                Case "Cancel / Reschedule Form"
                    Me.RadPane2.ContentUrl = "http://interwebdev/GeneralForms/Pages/Reschedule.aspx" ' WAS "http://cccwebdev/LegacyApps/Forms/resched__.aspx"
                Case "Channel Request"
                    Me.RadPane2.ContentUrl = "http://www1.wowway.com/event/module/moduleKeyword/chanreq/"
                Case "Check Serviceability"
                    Me.RadPane2.ContentUrl = "http://interwebdev/checkservice"
                Case "Customer Survey"
                    Me.RadPane2.ContentUrl = "http://cccweb/LegacyApps/surveytest/"
                Case "Equipment Return"
                    Me.RadPane2.ContentUrl = "http://interwebdev/Collections/Pages/EquipmentReturn/InquiryEntry.aspx"
                Case "Henry Ford E-Mail Form"
                    Me.RadPane2.ContentUrl = "http://cccwebdev/LegacyApps/Forms/cl_hford.aspx"
                ...
                Case "Collections PA", "Payment Arrangements"
                    Me.RadPane2.ContentUrl = "http://interwebdev/Collections/Pages/PaymentArrangements/PA_Entry.aspx"
                Case "Portal Feedback Form"
                    Me.RadPane2.ContentUrl = "http://cccwebdev/LegacyApps/Forms/portalmanage/portal__feedback.aspx"
                Case "Project Support Opps"
                    Me.RadPane2.ContentUrl = "http://cccwebdev/legacyapps/specialproject/"
                Case "Loss Prevention Form"
                    Me.RadPane2.ContentUrl = "http://interwebdev/GeneralForms/Pages/LossPrevention.aspx"
                Case "UPS Mailing Form"
                    Me.RadPane2.ContentUrl = "http://interwebdev/GeneralForms/Pages/UPSMailing.aspx"
                Case "WOW-A-Friend Form"
                    Me.RadPane2.ContentUrl = "http://64.233.207.29/ReferralTool/"
                Case "WOW! Phone Inquiry"
                    Me.RadPane2.ContentUrl = "http://interwebdev/GeneralForms/Pages/PhoneInquiry.aspx"
                Case "Seasonal Request"
                    Me.RadPane2.ContentUrl = "http://interwebdev/GeneralForms/Pages/SeasonalEntry.aspx"
                Case "Current Phone Ownership"
                    Me.RadPane2.ContentUrl = "http://interwebdev/GeneralForms/Pages/PhonePort.aspx"
                Case "Customer Care Suggestion Box"
                    Me.RadPane2.ContentUrl = "http://interwebdev/GeneralForms/Pages/WOWSuggestion.aspx"
                Case "Rate Guarantee Finder"
                    Me.RadPane2.ContentUrl = "http://interwebdev/GeneralForms/Pages/RateGuaranteeFinder.aspx"
                Case "Paper Fulfillment Request"
                    Me.RadPane2.ContentUrl = "http://interwebdev/PaperFulfillment/Pages/Request.aspx"
                Case "Paper Fulfillment Search"
                    Me.RadPane2.ContentUrl = "http://interwebdev/PaperFulfillment/Pages/Search.aspx"
                Case "FIT"
        ...
        Else
            ...
            Select Case key
                ...
                Case "Channel Request"
                    Me.RadPane2.ContentUrl = "http://www1.wowway.com/event/module/moduleKeyword/chanreq/"
                Case "Check Serviceability"
                    Me.RadPane2.ContentUrl = "http://interweb/checkservice"
                Case "Customer Survey"
                ...
                Case "Online Sales / Referral"
                    Me.RadPane2.ContentUrl = "http://cccreporting/oracle3/forms/referral/index.asp"
                Case "Collections PA", "Payment Arrangements"
                    Me.RadPane2.ContentUrl = "http://interweb/Collections/Pages/PaymentArrangements/PA_Entry.aspx"
                Case "Portal Feedback Form"
                ...
                Case "Paper Fulfillment Request"
                    Me.RadPane2.ContentUrl = "http://interweb/PaperFulfillment/Pages/Request.aspx"
                Case "Paper Fulfillment Search"
                    Me.RadPane2.ContentUrl = "http://interweb/PaperFulfillment/Pages/Search.aspx"
                Case "FIT"
                    Me.RadPane2.ContentUrl = "http://wowccc/fits/"
                Case "IVR"
                    Me.RadPane2.ContentUrl = "http://home.wideopenwest.com/WebForms/Pages/ivrpay.aspx"
